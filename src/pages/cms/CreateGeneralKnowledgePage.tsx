        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="border-0 shadow-xl bg-white">
            ...
            <CardContent className="pt-6 space-y-6">
              ...
              {/* Quick View Content (under 60 words) */}
              <div>
                <label className="text-sm font-semibold text-slate-700 mb-2 block">Quick View Content * (under 60 words)</label>
                <Textarea
                  placeholder="Enter a brief summary under 60 words..."
                  value={formData.quickViewContent}
                  onChange={(e) => setFormData({ ...formData, quickViewContent: e.target.value })}
                  className="mt-1 min-h-[100px]"
                  rows={4}
                />
                <p className="text-xs text-slate-500 mt-1">
                  {formData.quickViewContent.split(/\s+/).filter(Boolean).length} words (max 60)
                </p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-slate-500 mt-1">
                  The date when this general knowledge article was published or is relevant
                </p>
              </div>
              ...
              <div>
                <label className="text-sm font-semibold text-slate-700 mb-2 block">Add plus Auto Generated</label>
                <Input
                  placeholder="Additional keywords (auto-generated keywords will be added)"
                  value={formData.autoGeneratedKeywords}
                  onChange={(e) => setFormData({ ...formData, autoGeneratedKeywords: e.target.value })}
                  className="mt-1"
                />
              </div>
